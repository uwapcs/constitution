...
\begin{enumerate}
    ...
    \end{enumerate}
    \item No member of Committee may fill two roles simultaneously. Upon being appointed to a second position, they immediately cease to hold the first and are subject to the rules given in \cref{sec:committee}, \cref{sub:committee_resign}.
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item The executive office bears shall jointly and severally responsible for such compliance.
    \end{enumerate}
...
\begin{itemize}
    ...
    \item[] Revisions adopted by General Meeting on 2018-03-15
\end{itemize}
