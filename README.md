...
You can also [download a compiled PDF](https://github.com/uwapcs/constitution/raw/gh-pages/uwapcs_constitution.pdf) of the latest `master` branch version or [view it in your browser](https://github.com/uwapcs/constitution/blob/gh-pages/uwapcs_constitution.pdf). Note that this should but does not necessarily reflect the current official version.
